    ...
    <div className="absolute inset-0 min-h-[500px] flex items-center justify-center">
      <div className="relative flex flex-col gap-8 px-4 -mt-24">
        ...
        <div className="flex gap-2 flex-wrap justify-center">
          <PresetQuery query="Who said with great power comes great responsibility?"></PresetQuery>
          <PresetQuery query="Why do we only see one side of the moon?"></PresetQuery>
        </div>
        <div className="flex gap-2 flex-wrap justify-center">
          <PresetQuery query="Is llama better than ChatGPT?"></PresetQuery>
          <PresetQuery query="Tell me about the himalayas."></PresetQuery>
        </div>
        <Footer></Footer>
      </div>
    </div>
